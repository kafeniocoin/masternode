...
4. Send 100 KFN to this address and wait for at least 1 confirmation
...
```
bash <( curl -sL https://raw.githubusercontent.com/kafeniocoin/masternode/main/masternodeinstall.sh)
```
...
```<alias> <ip>:11427 <private_key> <tx_id> <index>```
3. It should look something like this:
``` MN1 127.0.0.2:11427 XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX X```
...
3. Enter ```kafeniocoin-cli getmasternodestatus```
